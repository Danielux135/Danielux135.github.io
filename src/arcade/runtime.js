...
const GAMES_I18N = {
    es: {
        ...
        perfect: 'Perfecto', good: 'Bien', ok: 'OK', miss: 'Fallo',
        ...
        bossIncoming: '¡JEFE!', fireHint: 'ESPACIO / CLIC = DISPARAR',
        g: {
            ...
            tempo:  { name: 'BPM Hunter',     desc: '¿Tienes ritmo de verdad? Sigue el pulso de la canción y compara tu BPM con el real.', how: '3 rondas de tap-tempo: toca el botón al ritmo. Cada ronda tiene menos ayudas.' },
            bass:      { name: 'Bass Invaders',         desc: 'Naves que bajan con cada golpe. En los drops aparece un jefe que crece con la energía.', how: 'Mueve la nave (arrastra, A/D o flechas). ESPACIO o clic para disparar. 3 vidas.' },
            party:     { name: 'Danielux Party Arena', desc: 'Sala online para jugar con amigos: impostor, bugs, boss, ritmo, mentiras, quiz, botons y subastas.', how: 'Crea una sala, comparte el código y lanza rondas rotatorias para 2-8 jugadores.' },
            beatblitz: { name: 'Beat Blitz',            desc: 'Toca exactamente en el beat. Cada acierto sube el combo y multiplica los puntos.', how: 'Pulsa ESPACIO o toca la pantalla en el momento exacto del beat. Combo × puntos.' },
        },
    },
    en: {
        open: 'Mini-games',
        ...
        bossIncoming: 'BOSS!', fireHint: 'SPACE / CLICK = FIRE',
        g: {
            ...
            tempo:  { name: 'BPM Hunter',     desc: 'Got real rhythm? Follow the pulse and compare your BPM with the real one.', how: '3 rounds of tap-tempo: each round hides more info. Tap the big button to the beat.' },
            bass:      { name: 'Bass Invaders',         desc: 'Ships descend with every hit. On drops a boss appears, growing with the energy.', how: 'Move the ship (drag, A/D or arrows). SPACE or click to fire. 3 lives.' },
            party:     { name: 'Danielux Party Arena', desc: 'Online room to play with friends: impostor, bugs, boss, rhythm, lies, quiz, buttons and auctions.', how: 'Create a room, share the code and launch rotating rounds for 2-8 players.' },
            beatblitz: { name: 'Beat Blitz',            desc: 'Tap exactly on the beat. Each hit raises your combo and multiplies your score.', how: 'Press SPACE or tap the screen on the exact beat. Combo × points.' },
        },
    },
    val: {
        open: 'Minijocs',
        ...
        perfect: "Perfecte", good: "Bé", ok: "OK", miss: "Errada",
        ...
        bossIncoming: "CAP!", fireHint: "ESPAI / CLIC = DISPARAR",
        g: {
            ...
            tempo:  { name: "BPM Hunter",     desc: "Tens ritme de veritat? Segueix el pols i compara el teu BPM amb el real.", how: "3 rondes de tap-tempo: cada ronda amaga més ajudes. Toca el botó gran al ritme." },
            bass:      { name: "Bass Invaders",         desc: "Naus que baixen amb cada colp. En els drops apareix un cap que creix amb l’energia.", how: "Mou la nau (arrossega, A/D o fletxes). ESPAI o clic per a disparar. 3 vides." },
            party:     { name: "Danielux Party Arena", desc: "Sala online per jugar amb amics: impostor, bugs, boss, ritme, mentides, quiz, botons i subhastes.", how: "Crea una sala, comparteix el codi i llança rondes rotatòries per a 2-8 jugadors." },
            beatblitz: { name: "Beat Blitz",            desc: "Toca exactament en el beat. Cada encert puja el combo i multiplica els punts.", how: "Polsa ESPAI o toca la pantalla en el moment exacte del beat. Combo × punts." },
        },
    },
};
